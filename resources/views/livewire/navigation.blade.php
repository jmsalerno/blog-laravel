<nav class="bg-violet-600" x-data={open:false}>
    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <button x-on:click="open = true" type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-violet-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    ...
                    <div class="flex space-x-4">
                        ...
                        @foreach ($categories as $category)
                            ...
                            <a href="{{route('posts.category', $category)}}" class="text-gray-300 hover:bg-violet-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                {{$category->name}}
                            </a>
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
        ...
        <div class="space-y-1 px-2 pt-2 pb-3">
            ...
            @foreach ($categories as $category )
                ...
                <a href="{{route('posts.category', $category)}}" class="text-gray-300 hover:bg-violet-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                    {{$category->name}}
                </a>
