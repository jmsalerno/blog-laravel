...
<article class="mt-8 bg-white shadow-lg rounded-lg overflow-hidden">
    @if ($post->image)
        <img class="h-80 w-full object-cover object-center" src="{{Storage::url($post->image->url)}}" alt="">
    @else

    <img class="h-80 w-full object-cover object-center" src="{{ asset('storage/img/img-blog-default.jpg') }}" alt="">
